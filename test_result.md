...
agent_communication:
    - agent: "main"
      message: "🎯 ONGLET DESSIN - CORRECTIONS MAJEURES APPLIQUÉES SELON RETOUR UTILISATEUR: ✅ NIVEAU D'EAU ÉLEVÉ: Repositionné plus proche de la surface dans le forage (30% du niveau dynamique, max 50m). ✅ CARTOUCHE TECHNIQUE DÉPLACÉ: Position bas-gauche pour ne plus cacher hauteur château d'eau. ✅ TUYAU DE REFOULEMENT PROLONGÉ: Continue jusqu'à l'INTÉRIEUR du château d'eau avec raccordement complet (horizontal + vertical + horizontal dans réservoir). ✅ INFORMATIONS ASPIRATION SUPPRIMÉES: Cartouche forage spécialisé sans aucune référence DN Aspiration. ✅ SCHÉMA FIXE: Dimensions statiques conformes aux attentes utilisateur. ✅ GESTION BACKSPACE: Tous champs numériques permettent effacement '0'. Interface professionnel prête production."
    - agent: "testing"
